...
const dummyTours = [
  {
    name: "Great Tour",
    descriptionShort:
      "Egestas purus viverra accumsan in nisl nisi scelerisque eu. Quam viverra orci sagittis eu volutpat. Sed vulputate odio ut enim. Suspendisse potenti nullam ac tortor vitae purus faucibus.",
    imageLink:
      "https://a.cdn-hotels.com/gdcs/production72/d3/a335d920-1a22-4f74-95be-e945479a8d8c.jpg",
  },
  {
    name: "Another Fun Tour",
    descriptionShort:
      "Consectetur lorem donec massa sapien faucibus et. Tempus imperdiet nulla malesuada pellentesque elit. Interdum velit euismod in pellentesque massa placerat duis ultricies lacus.",
    imageLink:
      "https://a.cdn-hotels.com/gdcs/production72/d3/a335d920-1a22-4f74-95be-e945479a8d8c.jpg",
  },
  {
  ...
  },
  {
    name: "Amazing Tour",
    descriptionShort:
      "Non consectetur a erat nam at lectus. Nisl pretium fusce id velit ut tortor pretium viverra. Ac feugiat sed lectus vestibulum mattis.",
    imageLink:
      "https://a.cdn-hotels.com/gdcs/production72/d3/a335d920-1a22-4f74-95be-e945479a8d8c.jpg",
  },
  {
    name: "Fun Fun Tour",
    descriptionShort:
      "Nisi lacus sed viverra tellus in hac habitasse. Fringilla phasellus faucibus scelerisque eleifend donec pretium vulputate sapien nec. Viverra maecenas accumsan lacus vel facilisis. Bibendum arcu vitae elementum curabitur vitae nunc sed. Consequat nisl vel pretium lectus quam id leo in.",
    imageLink:
      "https://a.cdn-hotels.com/gdcs/production72/d3/a335d920-1a22-4f74-95be-e945479a8d8c.jpg",
  },
  {
    name: "See New Things",
    descriptionShort:
      "Erat imperdiet sed euismod nisi porta. Semper feugiat nibh sed pulvinar proin. Quam vulputate dignissim suspendisse in est ante in nibh mauris.",
    imageLink:
      "https://a.cdn-hotels.com/gdcs/production72/d3/a335d920-1a22-4f74-95be-e945479a8d8c.jpg",
  },
  {
  ...
  },
  {
    name: "Art Tour",
    descriptionShort:
      "Nisl vel pretium lectus quam id leo. Tellus elementum sagittis vitae et leo duis. Est lorem ipsum dolor sit amet consectetur adipiscing.",
    imageLink:
      "https://a.cdn-hotels.com/gdcs/production72/d3/a335d920-1a22-4f74-95be-e945479a8d8c.jpg",
  },
];
...
const dummySteps = [
  {
    ...
    isFree: true,
    imageLink:
      "https://upload.wikimedia.org/wikipedia/commons/1/12/Bristol_Temple_Meads_station_%286466232797%29.jpg",
    audioLink: "1254975769",
  },
  {
    name: 'Castle Park',
    description:
      "Egestas purus viverra accumsan in nisl nisi scelerisque eu. Quam viverra orci sagittis eu volutpat. Sed vulputate odio ut enim. Suspendisse potenti nullam ac tortor vitae purus faucibus. Vel risus commodo viverra maecenas. Purus in mollis nunc sed. Aliquam id diam maecenas ultricies mi eget. Diam quis enim lobortis scelerisque fermentum dui faucibus in. Pretium nibh ipsum consequat nisl vel pretium lectus quam.",
    isFree: true,
    imageLink:
      "https://upload.wikimedia.org/wikipedia/commons/1/12/Bristol_Temple_Meads_station_%286466232797%29.jpg",
    audioLink: "1254975769",
  ...
  },
  {
    name: 'The Pool',
    description:
      "Ut morbi tincidunt augue interdum velit euismod. Egestas erat imperdiet sed euismod nisi. Ut etiam sit amet nisl purus in. Vitae sapien pellentesque habitant morbi tristique senectus et netus. Metus aliquam eleifend mi in nulla posuere sollicitudin. Morbi tempus iaculis urna id volutpat. Massa sed elementum tempus egestas sed sed risus pretium. Accumsan lacus vel facilisis volutpat est velit egestas dui id. Consequat id porta nibh venenatis cras sed. Imperdiet proin fermentum leo vel. Dolor magna eget est lorem ipsum dolor sit amet. In iaculis nunc sed augue lacus viverra vitae congue eu. Felis bibendum ut tristique et egestas quis ipsum suspendisse. Lorem ipsum dolor sit amet consectetur adipiscing elit. Laoreet non curabitur gravida arcu. Elementum sagittis vitae et leo duis ut diam. Platea dictumst vestibulum rhoncus est pellentesque. Eleifend mi in nulla posuere sollicitudin aliquam ultrices.",
    isFree: false,
    imageLink:
      "https://upload.wikimedia.org/wikipedia/commons/1/12/Bristol_Temple_Meads_station_%286466232797%29.jpg",
    audioLink: "1254975769",
...
async function main() {
  ...
  const dummyToursWithCity = dummyTours?.map((d) => {
    const randomCityId =
      allCityIDs[Math.floor(Math.random() * allCityIDs.length)];
  ...
  const dummyStepsWithTour = dummySteps?.map((s) => {
    const randomTourId =
      allTourIDs[Math.floor(Math.random() * allTourIDs.length)];
  ...
  allTourIDs?.map((tourId) => {
    temp = dummyStepsWithTour
      ?.filter((sT) => sT.tourId === tourId)
      ?.map((sT, index) => {
        sT.weight = index + 1;
        return sT;
      });
